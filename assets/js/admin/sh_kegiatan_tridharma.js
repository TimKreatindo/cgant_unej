...
function load_table() {
	...
	$("#main-table").dataTable({
		...
		order: [],
		ajax: {
			url: base_url + "admin/datatable-tridharma",
			type: "POST",
		},
		columnDefs: [
			{
...
$(document).on("submit", ".action-tridharma", function (e) {
	e.preventDefault();
			...
			setTimeout(() => {
				...
				if (d.status == false) {
					...
					if (d.status == false) {
						...
						let html_bukti = "";
						const base_file = base_url + "assets/upload/kegiatan-tridharma/";
						...
						let html = `<table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        ...
                                        <td>${main_data.tempat_kegiatan}</td>
                                    </tr>
                                    <tr>
                                        <th>Dibuat pada</th>
