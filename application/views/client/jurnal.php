            ...
            <table class="table table-bordered table-sm" id="main-table">
                ...
                <tbody>
                    ...
                    foreach($data as $d){
                        ...
                        if($decode_bukti->type == 'file'){
                            ...
                            foreach($decode_bukti->data as $db){
                                $li_bukti .= '<li><a href="'. base_url('assets/upload/jurnal/' . $db->file_name) . '" target="_blank">' . $db->ori_name . '</a></li>';
                            }
                    ...
                    <tr>
                        ...
                        <td><?= $bukti ?></td>
                        <td>
                            <?= form_open('client/validasi-jurnal', 'class="act-edit"') ?>
                            ...
                            <?= form_open('client/validasi-jurnal', 'class="act-delete"') ?>
                            <input type="hidden" name="id" value="<?= $d->id_encode ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group my-3">
                    <label><b>Jabatan dalam Jurnal</b></label>
