            ...
            <table class="table table-sm table-bordered" id="main-table">
                ...
                <tbody>
                    <?php $i=1; foreach($data as $d){ 
                        ...
                        if($decode_bukti->type == 'file'){
                            ...
                            foreach($decode_bukti->data as $db){
                                $li_bukti .= '<li><a href="'. base_url('assets/upload/sertifikat/' . $db->file_name) . '" target="_blank">' . $db->ori_name . '</a></li>';
                            }
                    ...
                    <tr>
                        ...
                        <td><?= $bukti ?></td>
                        <td>
                            <?= form_open('client/validasi-kompetensi', 'class="act-edit"') ?>
                            ...
                            <?= form_open('client/validasi-kompetensi', 'class="act-delete"') ?>
                            <input type="hidden" name="id" value="<?= $d->id_encode ?>">
...
<div class="modal" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?= form_open('client/validasi-kompetensi', 'id="form-modal"') ?>
            <div class="modal-body">
                ...
                <div class="form-group my-3">
                    <label><b>Jenis Sertifikat</b></label>
                    <select name="jenis_sertifikat" id="jenis_sertifikat" class="form-control" required>
                        <option value="">--pilih--</option>
                        <?php
                            foreach($jenis_sertifikat as $re){
                ...
                <div class="form-group my-3">
                    <label><b>Tingkat Sertifikasi</b></label>
                ...
                <div class="form-group my-3">
                    <label><b>Bidang Kompetensi</b></label>
                    <textarea name="bidang" id="bidang" class="form-control" rows="3" required></textarea>
                </div>

                <div class="form-group my-3">
                    <label><b>Lembaga Pemberi Sertifikat</b></label>
                    <textarea name="lembaga" id="lembaga" class="form-control" rows="3" required></textarea>
                </div>
