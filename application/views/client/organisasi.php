            ...
            <table class="table table-bordered table-sm" id="main-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $bukti ?></td>
                        <td>
                            <?= form_open('client/validasi-organisasi', 'class="act-edit"') ?>
                            ...
                            <?= form_open('client/validasi-organisasi', 'class="act-delete"') ?>
                            <input type="hidden" name="id" value="<?= $d->id_encode ?>">
